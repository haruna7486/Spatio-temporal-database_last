    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link active" href="spots_list_2.php">スポット一覧</a></li>
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="spot_detail_2.php?id=<?php echo htmlspecialchars($spot['id']); ?>"><?php echo htmlspecialchars($spot['spot_name']); ?></a></td>
